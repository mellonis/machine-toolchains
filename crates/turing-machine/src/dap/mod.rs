...
impl TmDapAdapter {
    ...
    fn frame_json(&self, id: i64, addr: u32) -> Value {
        ...
        // Attached only when a real line was emitted above: DAP's
        // `line: 0` is legal solely on a sourceless frame (1-based lines
        // otherwise), and a client maps a sourced line 0 to editor line
        // -1 (docs/dap.md (source provenance)).
