...
//! vector punctuation `* - < > . [ ]`. The 28 reserved keywords are NOT
...
/// The 28 fully-reserved `.tmc` keywords. Canonical home: they are ordinary
...
mod tests {
    ...
    /// The 28 reserved keywords are lexer-transparent: each is a plain
