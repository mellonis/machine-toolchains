 ...
 * [TmcLanguage]/[TmaLanguage] instead of falling back to a plain-text
 ...
 * with `tmt lsp`; nothing here is ever read for semantics.
 */
...
class TmcParserDefinition : TextOnlyParserDefinition(TmcLanguage, TmcFileType)
class TmaParserDefinition : TextOnlyParserDefinition(TmaLanguage, TmaFileType)
